          ...
          <div class="settings__body">
            ...
            <div class="settings__panel" data-panel="privacy">
              ...
              <section class="settings__section">
                ...
                <p class="benco-caption settings__hint">TLS protects everything end-to-end encryption can't: your login handshake, buddy list, presence, profiles, chat rooms, and who you talk to. There is no fallback: with this on, sign-on <strong>fails</strong> rather than connecting in the clear, which is what stops an attacker steering you onto the plaintext port. The server needs a TLS listener for it to work. Skipping the certificate check defeats the point of TLS — it accepts any server claiming to be this one — so use it only against a self-signed test server. <strong>Takes effect on your next sign-on.</strong></p>
